...
In Section~\ref{sec:urysohn-q-spaces}, we provide a positive answer.
...
$\mathfrak{ap}\leq\mathfrak{at}$, and we show that $\mathfrak{at}=\mathfrak q_2$ (Theorem~\ref{thm:at-equals-q2}), which concludes that $\mathfrak{ap}\leq\mathfrak q_2$.
