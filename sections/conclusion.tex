...
In this paper, we settled Problem~12 of \cite{banakh2023q} by proving that
...
Moreover, we answered Problem~11(1) of
...
& Theorems~\ref{thm:consistent-ap-below-at} and~\ref{thm:at-equals-q2}. \\
...
\begin{prob}\label{prob:remaining-q-cardinals}\hfill
    \begin{enumerate}[label=(\arabic*)]
        ...
        \item Is $q_{2\Delta}=\mathfrak q_{2\frac{1}{2}}$?
        \item Is $q_{2\Delta}=\mathfrak q_2$?
    \end{enumerate}
\end{prob}
\subsection*{Acknowledgements}
This study was financed by the São Paulo Research Foundation (FAPESP), Brazil.
Grant number:~\mbox{2025/07302-0}.
