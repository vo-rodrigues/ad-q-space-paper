...
First, we settle Question 12 of \cite{banakh2023q}.
...
\begin{proof}
    ...
    Thus, by Theorem \ref{maintool}, there exists $(a'_\alpha: \alpha<\lambda)$ such that $a'_\alpha\subseteq a_\alpha$ and for every two distinct
